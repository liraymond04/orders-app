...
/// Is the Next button should be display
  ...
  const IntroductionScreen({
    ...
    this.rtl = false,
        ...
        assert((showPrevButton && prev != null) || !showPrevButton),
...
class IntroductionScreenState extends State<IntroductionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final prevBtn = IntroButton(
      child: widget.prev,
      color: widget.prevColor ?? widget.color,
      onPressed: widget.showPrevButton && !_isScrolling ? previous : null,
    );
                    ...
                    children: [
                      Expanded(
                        ...
                        child: isSkipBtn
                            ...
                            : _toggleBtn(prevBtn, widget.showPrevButton && !isFirstPage),
                      ),
                      Expanded(
